...
const LightColumn = styled(Column)`
...
const Description = styled.p`
  ...
  line-height: 1.6;
  margin-bottom: 30px;
  color: ${props => props.light ? '#6c757d' : '#b0b8c1'};
`;
    ...
    <SectionContainer>
      <DarkColumn>
        <Content>
          ...
          <Description>
            At DG-Click, we pride ourselves on offering a comprehensive suite of printing and photography services to cater to all your needs. From high-quality digital printing for marketing collaterals and product packaging to professional event coverage and portrait photography, our team of experts is dedicated to providing you with the best possible results.
          </Description>
      ...
      <LightColumn>
        <Content>
          ...
          <Description light>
            At DG-Click, we believe that every moment is worthy of being captured and preserved. Our team of skilled photographers are masters of their craft, using the latest camera equipment and techniques to immortalize your special occasions, from weddings and corporate events to product launches and family portraits.
          </Description>
          <Button>Penatibus.</Button>
        </Content>
      </LightColumn>
    </SectionContainer>
  );
